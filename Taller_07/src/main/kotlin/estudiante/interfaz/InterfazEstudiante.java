...
public class InterfazEstudiante extends JFrame {
    ...
    public void actualizar() {
        ...
        panelCurso1.actualizar(estudiante.getCurso1());
        panelCurso2.actualizar(estudiante.getCurso2());
        panelCurso3.actualizar(estudiante.getCurso3());
        panelCurso4.actualizar(estudiante.getCurso4());
    }
     ...
     */
    public void cambiarCurso(String pCodigoActual, String pNuevoCodigo, String pNombre, String pDepartamento, int pCreditos) {
    ...
    public void reqFuncOpcion1() {
        Curso mejorCurso  = estudiante.mejorNota();
        if (mejorCurso != null) {
            String respuesta = String.format("El curso %s - %s tiene la nota más alta %.2f",
                    mejorCurso.getCodigo(), mejorCurso.getNombre(), mejorCurso.darNota());
            actualizar();
            JOptionPane.showMessageDialog(this, respuesta, "Respuesta", JOptionPane.INFORMATION_MESSAGE);
        }
        else {
            JOptionPane.showMessageDialog(this, "No hay cursos calificados aun");
        }
    }
    ...
    public void reqFuncOpcion2() {
        int cont = estudiante.cursosReprobados();
        String respuesta = "Hay " + cont + " cursos reprobados";
        actualizar();
        JOptionPane.showMessageDialog(this, respuesta, "Respuesta", JOptionPane.INFORMATION_MESSAGE);
    }
